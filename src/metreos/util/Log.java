/* $Id: Log.java 27001 2006-09-19 20:46:06Z sccomer $
 *
 * Created by wert on Feb 22, 2006.
 *
...
public class Log
{
	...
	public static void addSink( Sink sink )
	{
		if (sink == null)
		{
			// HACK: this is special hack that says add a default
			// log sink which prints to standard out.
			sink = new Sink()
			{
