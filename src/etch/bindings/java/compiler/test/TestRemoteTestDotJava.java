...
public class TestRemoteTestDotJava
{
	@org.junit.Test
	...
	public void method_incr1() throws Exception
	{
		...
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_incr,
	...
	public void method_sub1() throws Exception
	{
		...
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_sub,
	...
	public void method_sum() throws Exception
	{
		...
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_sum,
			new Field[] { ValueFactoryTest._mf_x },
			new Object[] { arg },
	...
	public void method_dist1() throws Exception
	{
		...
		Test.S1 arg1 =  new Test.S1( 1, 1, 1 );
		Test.S1 arg2 = new Test.S1( 0, 0, 0 );
		assertEquals( Math.sqrt( 3 ), test.dist( arg1, arg2 ) );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_dist,
	...
	public void method_dist2() throws Exception
	{
		...
		Test.S1 arg1 = new Test.S1( 1, 2, 3 );
		Test.S1 arg2 = new Test.S1( 6, 5, 4 );
	...
	public void method_dist3() throws Exception
	{
		...
		Test.S1 arg1 = new Test.S1( 1, 2, 3 );
		Test.S1 arg2 = new Test.S1( -1, -2, -3 );
	...
	public void method_fill1() throws Exception
	{
		...
		for (int i: x)
			assertEquals( 1, i );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_fill,
	...
	public void method_blow1() throws Exception
	{
		try
		{
			svc.xresult = new Test.Excp1( "foo", 2 );
			test.blow( "foo", 2 );
		...
		check( What.VOIDCALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_blow,
	...
	public void method_blow2() throws Exception
	{
		try
		{
			svc.xresult = new Test.Excp1( "bar", 3 );
			test.blow( "bar", 3 );
			fail( "blow did not throw" );
		}
		catch( Test.Excp1 e )
	...
	public void method_p_boolean_null() throws Exception
	{
		...
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_boolean,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_boolean_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_boolean_array,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_byte_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_byte,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_byte_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_byte_array,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_short_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_short,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_short_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_short_array,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_int_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_int,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_int_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_int_array,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_long_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_long,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_long_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_long_array,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_float_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_float,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_float_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_float_array,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_double_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_double,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_double_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_double_array,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_string_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_string,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_string_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_string_array,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_object_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_object,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_object_array() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_object_array,
			new Field[] { ValueFactoryTest._mf_a },
			new Object[] { a },
	...
	public void method_p_E1_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_E1,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_E1_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_E1_array,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_S1_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_S1,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_S1_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_S1_array,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_S2_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_S2,
			new Field[] {},
			new Object[] {},
	...
	public void method_p_S2_array_null() throws Exception
	{
		...
		assertObjectEquals( a, r );
		check( What.CALL,
			ValueFactoryTest._mt_etch_bindings_java_compiler_test_Test_p_S2_array,
			new Field[] {},
			new Object[] {},
...
//		System.out.println("size = " + svc.xmsg.size());
		...
		assertSame( "responseField", ValueFactoryTest._mf_result, svc.xresponseField );
		assertEquals( "timeout", timeout, svc.xtimeout );
	}
	
	public enum What { SEND, VOIDCALL, CALL, SHUTDOWNOUTPUT, BEGINCALL }
	
	private final MyDeliveryService svc = new MyDeliveryService();
	private final Test test = new RemoteTest( svc );
	...
	public static class MyDeliveryService implements DeliveryService
	{
			...
			Field responseField, int timeout ) throws Exception
		{
			...
			xtimeout = timeout;
			if (xresult != null && xresult instanceof Exception)
