...
import etch.bindings.java.compiler.test.Inheritance.E1;
import etch.bindings.java.compiler.test.Inheritance.E2;
import etch.bindings.java.compiler.test.Inheritance.E3;
import etch.bindings.java.compiler.test.Inheritance.S1;
import etch.bindings.java.compiler.test.Inheritance.S2;
import etch.bindings.java.compiler.test.Inheritance.S3;
...
public class TestInheritance
{
	...
	public void tostring() throws Exception
	{
		...
		assertEquals(
			"etch.bindings.java.compiler.test.Inheritance$E1: a=1; b=2",
			new E1( 1, 2 ).toString() );
		
		assertEquals(
			"etch.bindings.java.compiler.test.Inheritance$E2: a=1; b=2; c=3; d=4",
			new E2( 1, 2, 3, 4 ).toString() );
		
		assertEquals(
			"etch.bindings.java.compiler.test.Inheritance$E3: a=1; b=2; c=3; d=4; e=5; f=6",
