...
public class Test {
	...
	public void testStructs() throws Exception
	{
		...
		checkStructProperties(structNode, "S1", "-565219701", "etch.bindings.xml.compiler.test.Test.S1", "null", null);
		checkStructValueProperties(structNode, "a", "352988316", "a", "etch.bindings.xml.compiler.test.Test.S1", "false", "false", null, null);
		checkStructValueProperties(structNode, "b", "352988317", "b", "etch.bindings.xml.compiler.test.Test.S1", "false", "false", null, null);
		checkStructValueProperties(structNode, "c", "352988318", "c", "etch.bindings.xml.compiler.test.Test.E1", "false", "false", null, null);
		
		structNode = list.item(nodeCount++);
		
		checkStructProperties(structNode, "S2", "-565219700", "etch.bindings.xml.compiler.test.Test.S2", "null", "Omg\nIt's true\nSir!!");
		checkStructValueProperties(structNode, "x", "352988339", "x", "int", "true", "false", null, "X marks the spot");
		checkStructValueProperties(structNode, "y", "352988340", "y", "int", "true", "false", null, "Y\nis the thing");
		checkStructValueProperties(structNode, "z", "352988341", "z", "int", "true", "false", null, "Zebra!");
		checkStructValueProperties(structNode, "w", "352988338", "w", "int", "true", "true", "1", null);
	}
	...
	public void textExceptions() throws Exception
	{
		...
		checkExceptionProperties(exceptionNode, "Excp1", "false", "-1619183804", "etch.bindings.xml.compiler.test.Test.Excp1", "null", "This is a big error\nNO Way!!\nHello");
		...
		checkExceptionProperties(exceptionNode, "Excp2", "true", "-1619183803", "etch.bindings.xml.compiler.test.Test.Excp2", "null", null);
	}
	...
	public void testMethods() throws Exception
	{
		...
		checkMethodProperties(methodNode, "nothing", "-1751390848", "etch.bindings.xml.compiler.test.Test.nothing", "free", "false", "both", null, null, null);
		checkAuthorize(methodNode, null);
		checkResult(methodNode, "-1820164227", "etch.bindings.xml.compiler.test.Test._result_nothing", "void", "true", "false", null, null);

		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "_result_nothing", "-1820164227", "etch.bindings.xml.compiler.test.Test._result_nothing", 
				"none", "true", "both", "6000", null, "result");
		checkAuthorize(methodNode, null);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "incr", "871207937", "etch.bindings.xml.compiler.test.Test.incr", "queued", "false", "both", null, null, null);
		checkAuthorize(methodNode, null);
		checkMethodFieldProperties(methodNode, "x", "352988339", "x", "int", "true", "false", null, null);
		checkResult(methodNode, "-1982489532", "etch.bindings.xml.compiler.test.Test._result_incr", "int", "true", "false", null, null);
		...
		checkMethodProperties(methodNode, "m1", "1712502534", "etch.bindings.xml.compiler.test.TestClient.m1", "none", "false", "client", null, "Test\n1\n2", null);
		checkAuthorize(methodNode, null);
		...
		checkResult(methodNode, "-698754607", "etch.bindings.xml.compiler.test.TestServer._result_m1", "void", "true", "false", null, null);

		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "_result_m1", "-698754607", "etch.bindings.xml.compiler.test.TestServer._result_m1", 
...
//		verify that no unknown child nodes exist
	...
	{
		checkResult(methodNode, null, null, "void", "true", "false", null, null);
	}
