package etch.bindings.xml.compiler.test;
...
public class Test {
	...
	public void setUp() throws Exception {
		...
		try
		{
			File f = new File("src/etch/bindings/xml/compiler/test/Test.xml");
			if (!f.exists())
				f = new File("etch/bindings/xml/compiler/test/Test.xml");
	...
	public void testModule() throws Exception
	{
		...
		assertEquals(moduleName, "etch.bindings.xml.compiler.test");
		...
		assertEquals(descriptionValue, "My module description\nisn't half-bad.");
		
		// verify that no new attrs on description have come in
	...
	public void testService() throws Exception
	{
		...
		String descriptionValue = child.getTextContent().trim();
		assertEquals(descriptionValue, "My Service description\nis most amazing.");
	...
	public void testConsts() throws Exception
	{
		...
		checkConstProperties(list.item(nodeCount++), "BOOL1", getTypeName(EtchGrammarConstants.BOOLEAN), "false", "Testing a description of a constant");
	...
	public void testExterns() throws Exception
	{
		...
		checkExternProperties(externNode, "Blob", "477342410", "etch.bindings.xml.compiler.test.Test.Blob");
		...
		checkExternMapProperties(externNode, "csharp", "StrIntHashMap", "Etch.Util.StrIntHashMap", "StrIntHashMapSerializer",  "Etch.Util.StrIntHashMapSerializer");
	}
	...
	public void testEnums() throws Exception
	{
		...
		checkEnumProperties(enumNode, "E1", "-566138087", "etch.bindings.xml.compiler.test.Test.E1", null);
		...
		enumNode = list.item(nodeCount++);
		
		checkEnumProperties(enumNode, "E2", "-566138086", "etch.bindings.xml.compiler.test.Test.E2", "Omg\nIts an enum\nMa'am!!");
		checkEnumValueProperties(enumNode, "A", "352988284");
		checkEnumValueProperties(enumNode, "B", "352988285");
		checkEnumValueProperties(enumNode, "C", "352988286");
		checkEnumValueProperties(enumNode, "D", "352988287");
	}
	...
	public void testStructs() throws Exception
	{
		...
		checkStructProperties(structNode, "S1", "-565219701", "etch.bindings.xml.compiler.test.Test.S1", null);
		checkStructValueProperties(structNode, "a", "352988316", "a", "S1", "false", null, null);
		checkStructValueProperties(structNode, "b", "352988317", "b", "S1", "false", null, null);
		checkStructValueProperties(structNode, "c", "352988318", "c", "E1", "false", null, null);
		
		structNode = list.item(nodeCount++);
		
		checkStructProperties(structNode, "S2", "-565219700", "etch.bindings.xml.compiler.test.Test.S2", "Omg\nIt's true\nSir!!");
		checkStructValueProperties(structNode, "x", "352988339", "x", "int", "false", null, "X marks the spot");
		checkStructValueProperties(structNode, "y", "352988340", "y", "int", "false", null, "Y\nis the thing");
		checkStructValueProperties(structNode, "z", "352988341", "z", "int", "false", null, "Zebra!");
		checkStructValueProperties(structNode, "w", "352988338", "w", "int", "true", "1", null);
	}
	...
	public void textExceptions() throws Exception
	{
		...
		checkExceptionProperties(exceptionNode, "Excp1", "false", "-1619183804", "etch.bindings.xml.compiler.test.Test.Excp1", "This is a big error\nNO Way!!\nHello");
		checkExceptionValueProperties(exceptionNode, "msg", "769750364", "msg", "string", "false", null, "hehhehe my message");
		checkExceptionValueProperties(exceptionNode, "code", "-325551150", "code", "int", "false", null, "tsktsk tks code");
		
		exceptionNode = list.get(nodeCount++);
		
		checkExceptionProperties(exceptionNode, "Excp2", "true", "-1619183803", "etch.bindings.xml.compiler.test.Test.Excp2", null);
	}
	...
	public void testMethods() throws Exception
	{
		...
		checkMethodProperties(methodNode, "nothing", "-1751390848", "etch.bindings.xml.compiler.test.Test.nothing", "free", "false", "both", "4000", null);
		checkAuthorize(methodNode, null);
		checkResult(methodNode, "-1820164227", "etch.bindings.xml.compiler.test.Test._result_nothing", "void", "false", null, null);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "incr", "871207937", "etch.bindings.xml.compiler.test.Test.incr", "queued", "false", "both", "4000", null);
		checkAuthorize(methodNode, null);
		checkMethodFieldProperties(methodNode, "x", "352988339", "x", "int", "false", null, null);
		checkResult(methodNode, "-1982489532", "etch.bindings.xml.compiler.test.Test._result_incr", "int", "false", null, null);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "sum", "874329470", "etch.bindings.xml.compiler.test.Test.sum", "none", "false", "both", "4000", null);
		checkAuthorize(methodNode, null);
		checkMethodFieldProperties(methodNode, "x", "352988339", "x", "int", "true", "1", null);
		checkResult(methodNode, "98561147", "etch.bindings.xml.compiler.test.Test._result_sum", "int", "false", null, null);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "fill", "-1511270800", "etch.bindings.xml.compiler.test.Test.fill", "none", "false", "both", "4000", null);
		checkAuthorize(methodNode, null);
		checkMethodFieldProperties(methodNode, "n", "352988329", "n", "int", "false", null, null);
		checkMethodFieldProperties(methodNode, "x", "352988339", "x", "int", "false", null, null);
		checkResult(methodNode, "-70000973", "etch.bindings.xml.compiler.test.Test._result_fill", "int", "true", "1", null);
	
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "alwaysWorks", "899313734", "etch.bindings.xml.compiler.test.Test.alwaysWorks", "none", "false", "both", "4000", null);
		checkAuthorize(methodNode, "isTrue");
		checkResult(methodNode, "-253629117", "etch.bindings.xml.compiler.test.Test._result_alwaysWorks", "int", "false", null, null);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "isTrue", "-1995546491", "etch.bindings.xml.compiler.test.Test.isTrue", "none", "false", "both", "4000", null);
		checkAuthorize(methodNode, null);
		checkResult(methodNode, "2087745352", "etch.bindings.xml.compiler.test.Test._result_isTrue", "boolean", "false", null, null);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "alwaysFails", "588983161", "etch.bindings.xml.compiler.test.Test.alwaysFails", "none", "true", "both", "4000", null);
		checkAuthorize(methodNode, "isFalse");
		checkResult(methodNode);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "isFalse", "1221405260", "etch.bindings.xml.compiler.test.Test.isFalse", "none", "false", "both", "4000", null);
		checkAuthorize(methodNode, null);
		checkResult(methodNode, "1152631881", "etch.bindings.xml.compiler.test.Test._result_isFalse", "boolean", "false", null, null);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "m3", "-563514125", "etch.bindings.xml.compiler.test.Test.m3", "none", "false", "both", "4000", null);
		checkAuthorize(methodNode, "can_m1");
		checkResult(methodNode, "-1307038026", "etch.bindings.xml.compiler.test.Test._result_m3", "void", "false", null, null);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "can_m1", "-307006048", "etch.bindings.xml.compiler.test.Test.can_m1", "none", "false", "both", "4000", null);
		checkAuthorize(methodNode, null);
		checkResult(methodNode, "-518681501", "etch.bindings.xml.compiler.test.Test._result_can_m1", "boolean", "false", null, null);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "m1", "1712502534", "etch.bindings.xml.compiler.test.TestClient.m1", "none", "false", "client", "4000", "Test\n1\n2");
		checkAuthorize(methodNode, null);
		checkException(methodNode, "Excp1", "Exception test");
		checkMethodFieldProperties(methodNode, "x", "352988339", "x", "boolean", "false", null, "hi");
		checkResult(methodNode, "-1307038028", "etch.bindings.xml.compiler.test.Test._result_m1", "void", "false", null, null);
		
		methodNode = list.item(nodeCount++);
		
		checkMethodProperties(methodNode, "m2", "-563514126", "etch.bindings.xml.compiler.test.Test.m2", "none", "false", "both", "4000", "Test\na line is here");
		checkAuthorize(methodNode, null);
		checkException(methodNode, "Excp1", "Exception test value again");
		checkMethodFieldProperties(methodNode, "a", "352988316", "a", "string", "false", null, "test for A parameter");
		checkMethodFieldProperties(methodNode, "b", "352988317", "b", "string", "true", "1", "test for B parameter");
		checkResult(methodNode, "-1307038027", "etch.bindings.xml.compiler.test.Test._result_m2", "boolean", "false", null, "There is much to say about void!");
	}
	...
	private void checkConstProperties(Node node, String constName, String constType, String constValue, String constDescription)
	{
		...
		// verify that no unknown child nodes exist
		assertTrue(onlyChildNodesOfName(node, new String[] {"description"}));
		...
		Node child = getDescriptionElement(node);
		
		if(constDescription == null)
		{
			assertNull(child);
		
			// if description is null, no children should be present
			assertEquals(getChildElementCount(node), 0);
		}
		else
		{	
			String descriptionValue = child.getTextContent().trim();
			assertEquals(descriptionValue, constDescription);
	...
	private void checkStructProperties(Node structNode, String structName, String structTypeId, String structTypeName, String description)
	{
		NamedNodeMap attrs = structNode.getAttributes();
		
		// verify that no unknown attr exist
		assertTrue(onlyAttrsOfName(structNode, new String[] {"name", "typeId", "typeName"}));
	...
	private void checkStructValueProperties(Node structNode, String structName, String fieldId, String fieldName, String type, String isArray, String dimension, String description)
	{
		Node fieldNode = null;
	...
	private void checkExceptionProperties(Node exceptionNode, String name, String isUnchecked, String exceptionId, String exceptionName, String description)
	{
		NamedNodeMap attrs = exceptionNode.getAttributes();
		
		// verify that no unknown attr exist
		assertTrue(onlyAttrsOfName(exceptionNode, new String[] {"name", "isUnchecked", "typeId", "typeName"}));
...
//		verify that no unknown child nodes exist
	...
	private void checkMethodProperties(Node methodNode, String name, String methodId, String methodName, String pool, String isOneway, String direction, String timeout, String description)
	{
		...
		// verify that no new stuff has snuck into the XML binding
		assertEquals(attrs.getLength(), 7);
		...
		String timeoutAttr = attrs.getNamedItem("timeout").getNodeValue();
	...
	private void checkException(Node methodNode, String exceptionName, String description)
	{
		...
		// verify that no unknown attr exist
		assertTrue(onlyAttrsOfName(exceptionNode, new String[] {"name"}));
	...
	private void checkResult(Node methodNode)
	{
		checkResult(methodNode, null, null, "void", "false", null, null);
	}
	
	private void checkResult(Node methodNode, String fieldId, String fieldName, String type, String isArray, String dimension, String description)
	{
		Node resultNode = getResultElement(methodNode);
		
		// verify that no unknown attr exist
		assertTrue(onlyAttrsOfName(resultNode, new String[] {"fieldId", "fieldName", "type", "isArray", "dimension"}));
		...
		else // dimension attr is nullable, meaning it might just not be there if isArray = "false"
		{
			...
			assertEquals(attrs.getLength(), isArray == "false" ? 4 : 5);
		}
	...
	private void checkMethodFieldProperties(Node methodNode, String name, String fieldId, String fieldName, String type, String isArray, String dimension, String description)
	{
		Node fieldNode = null;
