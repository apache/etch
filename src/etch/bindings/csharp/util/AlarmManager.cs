...
namespace Etch.Util
{
    ...
    public class AlarmManager : AbstractStartable
    {
            ...
            if (alarmManager == null)
            {
                lock (alarmManagerSync)
                {
                    if (alarmManager == null)
                    {
                        ...
                        {
                            Console.WriteLine(" Exception in starting Alarm Manager Thread " + e.StackTrace);
        ...
        /// </summary>
        public readonly static int DEFAULT_NWORKERS = 1;
        ...
        public void Add(AlarmListener listener, Object state, int delay)
        {
            ...
            long due = HPTimer.Now() + delay * Timer.NANOS_PER_MILLI;
        ...
        private void Update(Alarm alarm, int delay)
        {
            long due = delay > 0
                ...
                : Timer.Nanos - delay * Timer.NANOS_PER_MILLI;
                    ...
                    while (true)
                    {
                        ...
                        if (delayNs > 0)
                        {
                            try
                            {
                                ...
                                if (delay > 0)
                                    System.Threading.Monitor.Wait(this, (int)delay);
                                continue;
                            }
                            catch (Exception e)
                            {
        ...
        private Alarm GetAlarm(AlarmListener listener)
        {
            ...
            try
            {
                alarm = alarmsByListener[listener];

            }
            catch (Exception)
            {
                Console.WriteLine("Alarm Does not exist in GetAlarm");
            }
            return alarm;
        ...
        private Alarm RemoveAlarm(AlarmListener listener)
        {
            ...
            {
                Console.WriteLine("Alarm Does not exist in Remove");
            }
