...
namespace Etch.Util
{
    ...
    public class Timer
    {
        ...
        /// </summary>
        public readonly static long NANOS_PER_MICRO = 1000;

        /// <summary>
        /// Number of nanoseconds per milliseconds.
        /// </summary>
        public readonly static long NANOS_PER_MILLI = 1000000;

        /// <summary>
        /// Number of nanoseconds per second.
        /// </summary>
        public readonly static double NANOS_PER_SECOND = 1000000000.0;
        ...
        public static long Nanos
        {
            get
            {
                return ( long ) DateTime.Now.Millisecond * NANOS_PER_MILLI;
            }
        }
        ...
        {
            return ( ( ( long ) DateTime.Now.Millisecond * NANOS_PER_MILLI ) - startTime );
        }
