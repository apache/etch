...
{ 
    ...
    public interface ValueFactory 
    {
        ...
        /// <summary>Adds a type to the set of types.</summary>
        ///<return> the argument. If there is a collision with an id and name, both associated with the same type,
        /// then that type is returned instead of the argument.</return>
        /// <param name="type">type a type to add. </param>
        ///  <throws> IllegalArgumentException if there is a collision in the id or name, or both id and name
        ///  when not associated with the same type.</throws>
        // XType AddType(XType type);
        ...
        /// <param>field a field to add.</param> 
        /// <returns>the argument.</returns>
        /// If there is a collision with an id and name, both associated with the same field,
        /// then that field is returned instead of the argument. 
        /// <throws>IllegalArgumentException if there is a collision in the id or name, or both id and name
        /// when not associated with the same field.</throws> 

        // Field AddField(Field field);

        /// <summary>Translates a field id into the appropriate Field object.</summary>
        /// <param> id a field id. </param>
        /// <returns>id translated into the appropriate Field. </returns>  
        Field GetField(int? id);

        /// <summary>Translates a field name into the appropriate Field object.</summary>
        /// <param> name a field name.</param>
        /// <returns> name translated into the appropriate Field.</returns>
        Field GetField(String name);

        /// <returns>a collection of all the fields.</returns>
        ICollection<Field> GetFields(); //Collection<Field> changed to ICollection
        ...
        /// 
        /// </summary>
        /// <param name="type">the type of a custom value</param>
        /// <returns>the class of a custom struct value type.</returns>
        Type GetCustomType( XType type );
    }
}