...
namespace Etch.Msg
{
    ...
    public sealed class Message : StructValue
    {
        ...
        /// <param name="vf"></param> vf the value factory.</param>
        ...
        /// <summary> Writes a message to the tagged data output</summary>
        /// <param name="tdo">tdo the tagged data output to write to.</param> 
        /// <throws>IOException if there is a problem with the tagged data output.</throws> 
