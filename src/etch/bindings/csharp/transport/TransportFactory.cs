...
namespace Etch.Transport
{
	...
	public abstract class TransportFactory
	{
        ...
        public abstract DeliveryService NewTransport( string uri, Resources resources );
	    ...
	    {
		    URL u = new URL( uri );
		    TransportFactory f = Get( u.Scheme );
        ...
        public abstract Transport<SessionListener> NewListener( string uri, Resources resources, ServerFactory factory );
        ...
        public static Transport<SessionListener> GetListener( string uri, Resources resources,ServerFactory factory ) 
	    {
		    URL u = new URL( uri );
		    TransportFactory f = Get( u.Scheme );
        ...
        {
            Add( "tcp", new TcpTransportFactory(false) );
            Add("tls", new TcpTransportFactory(true));
        }
	}
}
