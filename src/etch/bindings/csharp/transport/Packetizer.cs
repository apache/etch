...
namespace Etch.Transport
{
    ...
    public class Packetizer : SessionData, TransportPacket
    {
        ...
        private readonly static int SIG = unchecked( (int) 0xdeadbeef );

	    private readonly static int HEADER_SIZE = 8;
        
        /// <summary>
        /// The default maximum packet size that will be accepted, 16376 bytes.
        /// </summary>
        public readonly static int DEFAULT_MAX_PKT_SIZE = 16384 - HEADER_SIZE;
        ...
        private Packetizer( TransportData transport,  URL uri, Resources resources )
