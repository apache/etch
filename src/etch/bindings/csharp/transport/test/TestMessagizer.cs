...
namespace Etch.Transport.Test
{
    ...
    public class TestMessagizer
    {
        ...
        private readonly static sbyte VERSION = 3; // BinaryTaggedData.VERSION;
	private readonly static sbyte NONE = -127; // TypeCode.NONE;
	private readonly static sbyte BYTE = -124; // TypeCode.BYTE;
