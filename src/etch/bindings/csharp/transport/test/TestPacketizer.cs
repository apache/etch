...
namespace Etch.Transport.Test
{
    ...
    public class TestPacketizer
    {
        ...
        public void SetUp()
        {
            mph = new MyPacketHandler( this );
            p = new Packetizer(mph);
            p.SetSource( mph );
        }
        ...
        public void SendPacket()
        {
            ...
            Assert.AreEqual( mph.what, What.DATA );
	    ...
	    {
            SetUp();
		    p.TransportQuery( Connection<DataHandler>.LOCAL_ADDRESS );
    		
		    Assert.AreEqual(mph.what, What.LOCALADDRESS);
		    Assert.IsNull(mph.xsender);
		    Assert.IsNull(mph.xbuf);
	    }
	    ...
	    {
            SetUp();
            p.TransportQuery( Connection<DataHandler>.REMOTE_ADDRESS );
    		
		    Assert.AreEqual(mph.what, What.REMOTEADDRESS);
		    Assert.IsNull(mph.xsender);
		    Assert.IsNull(mph.xbuf);
	    }
	    ...
	    public void Stop()   
	    {
		    ...
		    Assert.AreEqual(mph.what, What.STOP);
		    Assert.IsNull(mph.xsender);
		    Assert.IsNull(mph.xbuf);
	    }
        ...
        public class MyPacketHandler : PacketHandler, DataSource
        {
            public Enum what;
            public Who xsender;
            public FlexBuffer xbuf;
            public Who xrecipient;
            public TestPacketizer _tp;
            ...
            public MyPacketHandler( TestPacketizer tp )
            {
                _tp = tp;
            }
            ...
            {
                if ( query.Equals( Connection<DataHandler>.LOCAL_ADDRESS ) )
                {
                    what = What.LOCALADDRESS;
                    return null;
                }
                if ( query.Equals( Connection<DataHandler>.REMOTE_ADDRESS ) )
                {
