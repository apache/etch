...
namespace Etch.Transport
{
    ...
    public sealed class FlexBuffer
    {
	    ...
	    private readonly static int INIT_BUFFER_LEN = 32;
	    
	    private readonly static int TRIM_BUFFER_LEN = 16*1024;
	
	    private readonly static int MAX_BUFFER_LEN = 4*1024*1024;
