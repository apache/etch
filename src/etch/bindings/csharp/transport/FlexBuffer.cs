...
namespace Etch.Transport
{
    ...
    public sealed class FlexBuffer
    {
        ...
        /// </summary>
        public FlexBuffer() : this(new byte[INIT_BUFFER_LEN], 0, 0)
        {
        ...
        public FlexBuffer(byte[] buffer) : this(buffer, 0, buffer.Length)
        {
        ...
        public FlexBuffer(byte[] buffer, int length) : this(buffer, 0, length)
        {
        ...
        private byte[] buffer = new byte[INIT_BUFFER_LEN];
	
	    private static int INIT_BUFFER_LEN = 32;
	
	    private static int MAX_BUFFER_LEN = 4*1024*1024;
