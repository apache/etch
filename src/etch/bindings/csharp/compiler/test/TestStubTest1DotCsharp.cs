...
namespace Etch.Compiler.Test
{
    ...
    public class TestStubTest1DotCsharp
    {
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_nothing, vf );
            // msg.Add( ValueFactoryTest1._mf_x, 3 );
		    stub.SessionMessage( null, msg );
		    // check the result.
            xreplyMon.WaitUntilNotEq( null );
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_nothing );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_incr, vf );
		    msg.Add( ValueFactoryTest1._mf_x, 3 );
		    stub.SessionMessage( null, msg );
		    // check the result.
            xreplyMon.WaitUntilNotEq( null );
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_incr );
		    Assert.AreEqual( 2, src.xreply.Count );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_sub, vf );
		    msg.Add( ValueFactoryTest1._mf_x, 7 );
		    msg.Add( ValueFactoryTest1._mf_y, 3 );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_sub );
		    Assert.AreEqual( 2, src.xreply.Count );
		    Assert.AreEqual( 4, src.xreply.Get( ValueFactoryTest1._mf_result ) );
	    }
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_sum, vf );
            msg.Add( ValueFactoryTest1._mf_x, new int[] { 1, 2, 3, 7, 11 } );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_sum );
		    Assert.AreEqual( 2, src.xreply.Count );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_trans, vf );
		    msg.Add( ValueFactoryTest1._mf_e, E1.A );
		    msg.Add( ValueFactoryTest1._mf_x, 5 );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_trans );
		    Assert.AreEqual( 2, src.xreply.Count );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_dist, vf );
		    msg.Add( ValueFactoryTest1._mf_a, new S1( 1, 1, 1 ) );
		    msg.Add( ValueFactoryTest1._mf_b, new S1( 0, 0, 0 ) );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_dist );
		    Assert.AreEqual( 2, src.xreply.Count );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_fill, vf );
		    msg.Add( ValueFactoryTest1._mf_n, 4 );
		    msg.Add( ValueFactoryTest1._mf_x, 3 );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_fill );
		    Assert.AreEqual( 2, src.xreply.Count );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_blow, vf );
		    msg.Add( ValueFactoryTest1._mf_msg, "foo" );
		    msg.Add( ValueFactoryTest1._mf_code, 23 );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_blow );
		    Assert.AreEqual( 2, src.xreply.Count );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_beets, vf );
		    msg.Add( ValueFactoryTest1._mf_e, E1.A );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_beets );
		    Assert.AreEqual( 2, src.xreply.Count );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_isTrue, vf );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_isTrue );
		    Assert.AreEqual( 2, src.xreply.Count );
		    Object o = src.xreply.Get( ValueFactoryTest1._mf_result );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_isFalse, vf );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_isFalse );
		    Assert.AreEqual( 2, src.xreply.Count );
		    Object o = src.xreply.Get( ValueFactoryTest1._mf_result );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_alwaysWorks, vf );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_alwaysWorks );
		    Assert.AreEqual( 2, src.xreply.Count );
		    Object o = src.xreply.Get( ValueFactoryTest1._mf_result );
	    ...
	    {
		    Message msg = new Message( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1_alwaysFails, vf );
		    stub.SessionMessage( null, msg );
		    // check the result.
		    src.xreply.CheckType( ValueFactoryTest1._mt_etch_bindings_csharp_compiler_test_Test1__result_alwaysFails );
		    Assert.AreEqual( 2, src.xreply.Count );
		    Object o = src.xreply.Get( ValueFactoryTest1._mf_result );
	    ...
	    public class MyMessageSource : DeliveryService
	    {
            ...
            public void Messagex( Who recipient, Message msg )
            {
                ...
                xreply = msg;
                _baseObj.xreplyMon.Set( new Message( new XType( "dummy" ), new ValueFactoryTest1() ) );
            }
