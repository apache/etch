...
namespace Etch.Support
{
    ...
    public class DefaultValueFactory : ValueFactory
    {
        ...
        private static readonly String ETCH_RUNTIME_EXCEPTION_TYPE_NAME = "_Etch_RuntimeException";

	    private static readonly String ETCH_LIST_TYPE_NAME = "_Etch_List";

	    private static readonly String ETCH_MAP_TYPE_NAME = "_Etch_Map";

	    private static readonly String ETCH_SET_TYPE_NAME = "_Etch_Set";

	    private static readonly String ETCH_DATETIME_TYPE_NAME = "_Etch_Datetime";

	    private static readonly String ETCH_AUTH_EXCEPTION_TYPE_NAME = "_Etch_AuthException";

	    private static readonly String ETCH_EXCEPTION_MESSAGE_NAME = "_exception";

	    private static readonly String MSG_FIELD_NAME = "msg";

	    private static readonly String MESSAGE_ID_FIELD_NAME = "_messageId";

	    private static readonly String IN_REPLY_TO_FIELD_NAME = "_inReplyTo";

        private static readonly String RESULT_FIELD_NAME = "result";
       ...
       ///<param name = class2type></param>
        public DefaultValueFactory(TypeMap types, Class2TypeMap class2type)
        {
            this.types = types;
        ...
        public StructValue ExportCustomValue( Object value )
        {
		    ...
		    return helper.ExportValue( value );
        }
