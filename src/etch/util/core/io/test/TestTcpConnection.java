...
import etch.util.core.io.SessionData;
...
//	}
	...
	public void constructor7() throws Exception
	{
		...
		new TcpConnection( null, "tcp://localhost:1?TcpConnection.reconnect_delay=-1", null );
	}
	...
	public void restart1() throws Exception
	{
		...
		MyDataHandler dh = new MyDataHandler();
		TcpConnection c = new TcpConnection( null, "tcp://127.0.0.1:"+port+"?TcpConnection.reconnect_delay=200", null );
		c.setSession( dh );
