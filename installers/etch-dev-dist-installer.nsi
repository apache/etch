...
!ifndef ROOT_DIRECTORY
    !define ROOT_DIRECTORY "..\build\Installers\dist"
!endif
!ifndef OUT_FILE
    !define OUT_FILE "etch-${PRODUCT_VERSION}-dev-dist.exe"
!endif
...
Section "MainSection"
  ...
  SetOutPath $INSTDIR
  File "${ROOT_DIRECTORY}\*.txt"
  
  SetOutPath "$INSTDIR\bin"
  File /r "${ROOT_DIRECTORY}\bin\*.*"
  
  SetOutPath "$INSTDIR\lib"
  File /r /x *.zip "${ROOT_DIRECTORY}\lib\*.*"
  
  SetOutPath "$INSTDIR\examples\chat"
  File /r "${ROOT_DIRECTORY}\examples\chat\*.*"
