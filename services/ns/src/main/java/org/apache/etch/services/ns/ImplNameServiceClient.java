 ...
 */
public class ImplNameServiceClient extends BaseNameServiceClient
{
	/**
	 * Constructs the ImplNameServiceClient.
	 *
	 * @param server a connection to the server session. Use this to send a
	 * message to the server.
	 */
	public ImplNameServiceClient( RemoteNameServiceServer server )
	{
		this.server = server;
	}
	...
	private final RemoteNameServiceServer server;

	// TODO insert methods here to provide implementations of NameServiceClient
	...
	public void _sessionNotify( Object event ) throws Exception
	{
		...
		{
			System.out.println("Service couldn't establish connection with the Name Service.");
		}
